 ...
 */
public class InfoDialog extends AbstractInformationDialog {
	/**
	...
	public InfoDialog(String subTitle, String dialogMessage) {
		this(SpringCoreUIPlugin.getActiveShell(), SpringCoreUIPlugin.getDefault().getImages().getImage(PluginImages.LOGO_BASIC_INFO_64), subTitle, dialogMessage);
	}
	 /**
	...
	public InfoDialog(Shell parentShell, Image image, String subTitle, String dialogMessage) {
		this(parentShell, "Basic Info Dialog", subTitle, null, dialogMessage, null, new String[] { IDialogConstants.OK_LABEL, IDialogConstants.SHOW_DETAILS_LABEL }, 0, 1, image);
	}
	 /**
     * This constructor allows you to use your own shell and image.<br>
     * 
	...
	public InfoDialog(Shell parentShell, Image image, String subTitle, String dialogMessage, Object detail) {
		this(parentShell, "Basic Info Dialog", subTitle, null, dialogMessage, detail, new String[] { IDialogConstants.OK_LABEL, IDialogConstants.SHOW_DETAILS_LABEL }, 0, -1, image);
	}
	  /**
     * @param parentShell
     * @param dialogTitle
