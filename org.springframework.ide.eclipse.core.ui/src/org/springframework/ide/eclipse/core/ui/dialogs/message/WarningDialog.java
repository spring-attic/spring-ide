...
public class WarningDialog extends AbstractInformationDialog {
	...
	public WarningDialog(String subTitle, String dialogMessage) {
		this(SpringCoreUIPlugin.getActiveShell(), SpringCoreUIPlugin.getDefault().getImages().getImage(PluginImages.LOGO_BASIC_WARNING_64), subTitle, dialogMessage);
	}

	/**
	 * This constructor use the active Shell for the org.springframework.ide.eclipse.core.ui.SpringCoreUIPlugin If this plugin is not available in the context of the call (e.g. not started) use a constructor allowing the specification of the shell. This constructor also uses a default image from this plugin.<br>
	 * If this plugin is not available in the context of the call (e.g. not started) use a constructor allowing the specification of the image.<br>
	 * 
	...
	public WarningDialog(String subTitle, String dialogMessage, Object detail) {
		this(SpringCoreUIPlugin.getActiveShell(), SpringCoreUIPlugin.getDefault().getImages().getImage(PluginImages.LOGO_BASIC_WARNING_64), subTitle, dialogMessage, detail);
	}
	...
	public WarningDialog(Shell parentShell, Image image, String subTitle, String dialogMessage) {
		this(SpringCoreUIPlugin.getActiveShell(), "Basic Warning Dialog", subTitle, null, dialogMessage, null, new String[] { IDialogConstants.OK_LABEL}, 0, -1, image);
	}
	...
	public WarningDialog(Shell parentShell, Image image, String subTitle, String dialogMessage, Object detail) {
		this(SpringCoreUIPlugin.getActiveShell(), "Basic Warning Dialog", subTitle, null, dialogMessage, detail, new String[] { IDialogConstants.OK_LABEL, IDialogConstants.SHOW_DETAILS_LABEL }, 0, 1, image);
	}
