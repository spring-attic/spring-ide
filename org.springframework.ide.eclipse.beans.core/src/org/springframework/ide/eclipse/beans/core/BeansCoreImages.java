...
public class BeansCoreImages {
	...
	private static final String NAME_PREFIX = BeansCorePlugin.PLUGIN_ID + '.';
	...
	static {
		try {
			ICON_BASE_URL = new URL(BeansCorePlugin.getDefault().getBundle()
	...
	public static final ImageDescriptor DESC_OBJS_ANNOTATATION = createManaged(OBJECT, IMG_OBJS_ANNOTATION);
	...
	public static Image getImage(String key) {
		return BeansCorePlugin.getDefault().getImageRegistry().get(key);
	}
