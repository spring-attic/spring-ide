 ...
 * BeansCoreModel in in <code><test property="..."/></code> expressions.
 * Currently the following propeties are supported:
 * <ul>
 * <li><strong>isBeansConfig</strong> checks if a given <code>IFile</code> is
 * 		a BeansConfig file</li>
 * </ul>
...
public class BeansModelPropertyTester extends PropertyTester {
	...
	public boolean test(Object receiver, String property, Object[] args,
		...
		if (receiver instanceof IFile) {
			...
			if ("isBeansConfig".equals(property)) {
				IBeansProject project = BeansCorePlugin.getModel()
						.getProject(file.getProject());
				boolean isBeansConfig = project.hasConfig(file);
