...
public class AopNamespaceAwareEditorContribution implements
	...
	private AopContentAssistProcessor contentAssistProcessor = new AopContentAssistProcessor();
	
	private AopOutlineLabelProvider labelProvider;
	
    private AopHyperLinkDetector hyperLinkDetector;
	...
	public JFaceNodeLabelProvider getLabelProvider(
		...
		if (this.labelProvider == null) {
			this.labelProvider = new AopOutlineLabelProvider(configuration, parent);
		}
    ...
    public IHyperlinkDetector getHyperLinkDetector() {
        if (this.hyperLinkDetector == null) {
            this.hyperLinkDetector = new AopHyperLinkDetector();
        }
