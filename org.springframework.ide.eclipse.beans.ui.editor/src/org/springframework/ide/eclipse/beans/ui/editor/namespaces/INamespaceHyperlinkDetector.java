...
/**
 * Implementations of this interface are able to calculate {@link IHyperlink}
 * instances for a given attribute.
...
public interface INamespaceHyperlinkDetector {
	 ...
	 * <p>
	 * Note: this method will only be called if {@link #isLinkableAttr(Attr)}
	 * returns true.
	 */
	...
	/**
	 * Checks if this {@link INamespaceHyperlinkDetector} supports the hyperlink
	 * calculation for the given attribute.
	 */
