...
public class LangUIImages {
     ...
     */
    public static final String IMG_OBJS_LANG = NAME_PREFIX + "script_obj.gif";

    public static final ImageDescriptor DESC_OBJS_LANG = createManaged(STRUCTURE, IMG_OBJS_LANG);
