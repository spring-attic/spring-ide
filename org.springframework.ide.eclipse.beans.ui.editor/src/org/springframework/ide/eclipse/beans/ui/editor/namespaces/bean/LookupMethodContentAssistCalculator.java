...
/**
 * {@link NodeClassMethodContentAssistCalculator} that calculates content assist
 * proposals for the <code>lookup-method</code> element.
 * @author Christian Dupuis
 * @since 2.0.2
 */
@SuppressWarnings("restriction")
public class LookupMethodContentAssistCalculator extends
