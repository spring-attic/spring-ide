...
public class BeansJavaCompletionProposalCollector
     ...
     * <code>ICompilationUnit</code> is not contained in an {@link IJavaProject}, no javadoc will
     * be available as
    ...
    /**
     * Creates a new instance ready to collect proposals. Note that proposals for anonymous types
     * and method declarations are not created when using this constructor, as those need to know
     * the compilation unit that they are created on. Use
     * {@link CompletionProposalCollector#CompletionProposalCollector(ICompilationUnit)} instead to
     * get all proposals. <p> If the passed Java project is <code>null</code>, no javadoc will be
     * available as
     * {@link org.eclipse.jface.text.contentassist.ICompletionProposal#getAdditionalProposalInfo() additional info}
     * on the created (e.g. method and type) proposals. </p>
     * 
