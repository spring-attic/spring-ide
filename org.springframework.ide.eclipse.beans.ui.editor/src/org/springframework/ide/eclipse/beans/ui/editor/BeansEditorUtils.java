...
public class BeansEditorUtils {
    ...
    public static int getBeanFlags(IBean bean) {
    ...
    private static void getClassNamesOfBeans(IFile file, Document document, String id,
            String className, String parentId, List classNames, List beans) {
