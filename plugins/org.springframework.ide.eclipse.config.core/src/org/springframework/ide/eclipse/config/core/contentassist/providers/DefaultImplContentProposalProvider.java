...
import org.springframework.ide.eclipse.beans.ui.editor.contentassist.aop.DefaultImplContentAssistCalculator;
 ...
 * {@link DefaultImplContentAssistCalculator} as its content assist calculator.
 * @author Leo Dos Santos
 * @author Christian Dupuis
 * @since 2.0.0
 */
@SuppressWarnings("restriction")
public class DefaultImplContentProposalProvider extends XmlBackedContentProposalProvider {
	 ...
	 */
	public DefaultImplContentProposalProvider(IDOMElement input, String attrName) {
		super(input, attrName);
	}

	@Override
	protected IContentAssistCalculator createContentAssistCalculator() {
		return new DefaultImplContentAssistCalculator();
	}
