...
/**
 * Schema constants for Spring Integration Websocket extension.
 *
 * @author Alex Boyko
 *
 */
public class IntWebsocketSchemaConstants {

	// URI

	public static final String URI = "http://www.springframework.org/schema/integration/websocket"; //$NON-NLS-1$
