...
/**
 * Blueprint schema derived from
 * <code>https://www.osgi.org/xmlns/blueprint/v1.0.0/blueprint.xsd</code>
 * @author Leo Dos Santos
 * @since STS 2.3.1
 * @version OSGi Blueprint 1.0.0
 */
public class BlueprintSchemaConstants {

	// URI

	public static String URI = "http://www.osgi.org/xmlns/blueprint/v1.0.0"; //$NON-NLS-1$

	// Element tags

	public static String ELEM_ARGUMENT = "argument"; //$NON-NLS-1$

	public static String ELEM_ARRAY = "array"; //$NON-NLS-1$

	public static String ELEM_BEAN = "bean"; //$NON-NLS-1$

	public static String ELEM_BLUEPRINT = "blueprint"; //$NON-NLS-1$
	...
	public static String ELEM_REFERENCE_LIST = "reference-list"; //$NON-NLS-1$

	public static String ELEM_REFERENCE_LISTENER = "reference-listener"; //$NON-NLS-1$
	...
	public static String ELEM_TYPE_CONVERTERS = "type-converters"; //$NON-NLS-1$

	public static String ELEM_VALUE = "value"; //$NON-NLS-1$

	// Attribute tags

	public static String ATTR_ACTIVATION = "activation"; //$NON-NLS-1$

	public static String ATTR_AUTO_EXPORT = "auto-export"; //$NON-NLS-1$

	public static String ATTR_AVAILABILITY = "availability"; //$NON-NLS-1$

	public static String ATTR_BIND_METHOD = "bind-method"; //$NON-NLS-1$

	public static String ATTR_CLASS = "class"; //$NON-NLS-1$

	public static String ATTR_COMPONENT_ID = "component-id"; //$NON-NLS-1$

	public static String ATTR_COMPONENT_NAME = "component-name"; //$NON-NLS-1$

	public static String ATTR_DEFAULT_ACTIVATION = "default-activation"; //$NON-NLS-1$

	public static String ATTR_DEFAULT_AVAILABILITY = "default-availability"; //$NON-NLS-1$

	public static String ATTR_DEFAULT_TIMEOUT = "default-timeout"; //$NON-NLS-1$
	...
	public static String ATTR_FACTORY_REF = "factory-ref"; //$NON-NLS-1$
	...
	public static String ATTR_KEY_REF = "key"; //$NON-NLS-1$

	public static String ATTR_KEY_TYPE = "key-type"; //$NON-NLS-1$

	public static String ATTR_MEMBER_TYPE = "member-type"; //$NON-NLS-1$
	...
	public static String ATTR_UNBIND_METHOD = "unbind-method"; //$NON-NLS-1$
