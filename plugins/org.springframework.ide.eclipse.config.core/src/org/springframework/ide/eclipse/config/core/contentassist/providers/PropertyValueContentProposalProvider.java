 ...
 * {@link PropertyValueContentAssistCalculator} as its content assist
 * calculator.
...
public class PropertyValueContentProposalProvider extends XmlBackedContentProposalProvider {
	 ...
	 */
	public PropertyValueContentProposalProvider(IDOMElement input, String attrName) {
		super(input, attrName);
	}

	@Override
	protected IContentAssistCalculator createContentAssistCalculator() {
		return new PropertyValueContentAssistCalculator();
	}
