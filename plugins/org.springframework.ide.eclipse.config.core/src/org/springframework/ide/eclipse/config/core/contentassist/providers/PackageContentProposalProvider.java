 ...
 * {@link PackageContentAssistCalculator} as its content assist calculator.
 * @author Leo Dos Santos
 * @author Christian Dupuis
 * @since 2.0.0
 */
@SuppressWarnings("restriction")
public class PackageContentProposalProvider extends XmlBackedContentProposalProvider {
	 ...
	 */
	public PackageContentProposalProvider(IDOMElement input, String attrName) {
		super(input, attrName);
	}

	@Override
	protected IContentAssistCalculator createContentAssistCalculator() {
		return new PackageContentAssistCalculator();
	}
