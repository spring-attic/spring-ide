 ...
 * {@link InitDestroyMethodContentAssistCalculator} as its content assist
 * calculator.
...
public class InitDestroyMethodContentProposalProvider extends XmlBackedContentProposalProvider {
	 ...
	 */
	public InitDestroyMethodContentProposalProvider(IDOMElement input, String attrName) {
