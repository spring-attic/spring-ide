...
/**
 * Schema constants for Spring Integration JGroups extension.
 *
 * @author Alex Boyko
 *
 */
public class IntJGroupsSchemaConstants {

	// URI

	public static final String URI = "http://www.springframework.org/schema/integration/jgroups"; //$NON-NLS-1$
