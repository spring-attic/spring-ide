...
import org.springframework.ide.eclipse.webflow.ui.editor.contentassist.webflow.SubflowReferenceContentAssistCalculator;


/**
 * An {@link XmlBackedContentProposalProvider} that uses
 * {@link SubflowReferenceContentAssistCalculator} as its content assist
 * calculator.
 * @author Leo Dos Santos
 * @since 2.3.4
 */
@SuppressWarnings("restriction")
public class SubflowReferenceContentProposalProvider extends XmlBackedContentProposalProvider {
	 ...
	 */
	public SubflowReferenceContentProposalProvider(IDOMElement input, String attrName) {
		super(input, attrName);
	}

	@Override
	protected IContentAssistCalculator createContentAssistCalculator() {
		return new SubflowReferenceContentAssistCalculator();
	}
