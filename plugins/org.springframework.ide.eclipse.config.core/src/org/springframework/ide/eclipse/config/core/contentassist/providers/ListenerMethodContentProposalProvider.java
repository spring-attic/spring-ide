...
import org.springframework.ide.eclipse.beans.ui.editor.contentassist.jms.ListenerMethodContentAssistCalculator;
 ...
 * {@link ListenerMethodContentAssistCalculator} as its content assist
 * calculator.
...
public class ListenerMethodContentProposalProvider extends XmlBackedContentProposalProvider {
	 ...
	 */
	public ListenerMethodContentProposalProvider(IDOMElement input, String attrName) {
		super(input, attrName);
	}

	@Override
	protected IContentAssistCalculator createContentAssistCalculator() {
		return new ListenerMethodContentAssistCalculator();
	}
