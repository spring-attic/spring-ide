...
/**
 * Constants for Voldemort Spring Integration extension.
 *
 * @author Alex Boyko
 *
 */
public class IntVoldemortSchemaConstants {
	// URI

	public static final String URI = "http://www.springframework.org/schema/integration/voldemort"; //$NON-NLS-1$
