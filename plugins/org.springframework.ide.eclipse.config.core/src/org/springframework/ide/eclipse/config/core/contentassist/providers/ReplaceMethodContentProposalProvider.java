 ...
 * {@link ReplaceMethodContentAssistCalculator} as its content assist
 * calculator.
...
public class ReplaceMethodContentProposalProvider extends XmlBackedContentProposalProvider {
	 ...
	 */
	public ReplaceMethodContentProposalProvider(IDOMElement input, String attrName) {
		super(input, attrName);
	}

	@Override
	protected IContentAssistCalculator createContentAssistCalculator() {
		return new ReplaceMethodContentAssistCalculator();
	}
