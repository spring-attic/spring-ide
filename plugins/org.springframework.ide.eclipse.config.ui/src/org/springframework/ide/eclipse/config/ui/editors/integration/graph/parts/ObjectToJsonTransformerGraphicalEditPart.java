 ...
 */
public class ObjectToJsonTransformerGraphicalEditPart extends BorderedIntegrationPart {

	public ObjectToJsonTransformerGraphicalEditPart(ObjectToJsonTransformerModelElement transformer) {
		super(transformer);
	}
	...
	@Override
	public ObjectToJsonTransformerModelElement getModelElement() {
		return (ObjectToJsonTransformerModelElement) getModel();
	}
