 ...
 */
public class TcpInboundGatewayGraphicalEditPart extends BorderedIntegrationPart {

	public TcpInboundGatewayGraphicalEditPart(TcpInboundGatewayModelElement gateway) {
		super(gateway);
	}
	...
	protected IFigure createFigure() {
		...
		l.setIcon(IntegrationImages.getImageWithBadge(IntegrationImages.INBOUND_GATEWAY, IntegrationImages.BADGE_SI_IP));
		return l;
	}

	@Override
	public TcpInboundGatewayModelElement getModelElement() {
		return (TcpInboundGatewayModelElement) getModel();
	}
