 ...
 *
 */
public class BadgedRouterGraphicalPart extends AbstractRouterGraphicalEditPart {

	private final ImageDescriptor mainImageDescriptor;

	private final ImageDescriptor auxImageDescriptor;

	public BadgedRouterGraphicalPart(AbstractRouterModelElement activity, ImageDescriptor mainImageDescriptor,
	...
	@Override
	public AbstractRouterModelElement getModelElement() {
		return (AbstractRouterModelElement) getModel();
	}
