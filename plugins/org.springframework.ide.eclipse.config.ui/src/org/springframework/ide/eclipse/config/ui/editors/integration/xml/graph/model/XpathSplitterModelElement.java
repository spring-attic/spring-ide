...
public class XpathSplitterModelElement extends Activity {

	public XpathSplitterModelElement() {
		super();
	}

	public XpathSplitterModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntXmlSchemaConstants.ELEM_XPATH_SPLITTER;
	}
