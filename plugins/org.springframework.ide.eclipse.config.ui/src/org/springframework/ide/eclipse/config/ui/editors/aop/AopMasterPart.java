...
public class AopMasterPart extends AbstractNamespaceMasterPart {

	public AopMasterPart(AbstractConfigFormPage page, Composite parent) {
		super(page, parent);
	}
	...
	protected String getSectionTitle() {
		return Messages.getString("AopMasterPart.MASTER_SECTION_TITLE"); //$NON-NLS-1$
	}
