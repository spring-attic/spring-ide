...
public class OverviewMasterPart extends AbstractNamespaceMasterPart {

	public OverviewMasterPart(AbstractConfigFormPage page, Composite parent) {
		super(page, parent);
	}
	...
	protected String getSectionTitle() {
		return Messages.getString("OverviewMasterPart.MASTER_SECTION_TITLE"); //$NON-NLS-1$
	}
