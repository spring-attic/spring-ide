...
public class LangMasterPart extends AbstractNamespaceMasterPart {

	public LangMasterPart(AbstractConfigFormPage page, Composite parent) {
		super(page, parent);
	}
	...
	protected String getSectionTitle() {
		return Messages.getString("LangMasterPart.MASTER_SECTION_TITLE"); //$NON-NLS-1$
	}
