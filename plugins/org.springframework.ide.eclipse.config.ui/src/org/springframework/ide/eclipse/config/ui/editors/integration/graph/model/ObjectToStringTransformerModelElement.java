...
public class ObjectToStringTransformerModelElement extends Activity {

	public ObjectToStringTransformerModelElement() {
		super();
	}

	public ObjectToStringTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_OBJECT_TO_STRING_TRANSFORMER;
	}
