...
public class ImplicitChannelModelElement extends Activity {

	public ImplicitChannelModelElement() {
		super();
	}

	public ImplicitChannelModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}
