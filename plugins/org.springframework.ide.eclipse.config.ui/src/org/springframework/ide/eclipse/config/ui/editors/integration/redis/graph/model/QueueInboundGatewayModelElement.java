...
public class QueueInboundGatewayModelElement extends AbstractInboundGatewayModelElement {

	public QueueInboundGatewayModelElement() {
		super();
	}

	public QueueInboundGatewayModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntRedisSchemaConstants.ELEM_QUEUE_INBOUND_GATEWAY;
	}
