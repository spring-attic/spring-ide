 ...
 * {@link PropertyNameHyperlinkCalculator} as its hyperlink calculator.
 * @author Leo Dos Santos
 * @author Christian Dupuis
 * @since 2.0.0
 */
@SuppressWarnings("restriction")
public class PropertyNameHyperlinkProvider extends XmlBackedHyperlinkProvider {
	 ...
	 * for
	 */
	public PropertyNameHyperlinkProvider(ITextViewer textViewer, IDOMElement input, String attrName) {
		super(textViewer, input, attrName);
	}

	@Override
	protected IHyperlinkCalculator createHyperlinkCalculator() {
		return new PropertyNameHyperlinkCalculator();
	}
