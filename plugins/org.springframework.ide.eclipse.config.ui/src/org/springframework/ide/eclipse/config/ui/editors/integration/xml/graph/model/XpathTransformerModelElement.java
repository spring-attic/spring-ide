...
public class XpathTransformerModelElement extends Activity {

	public XpathTransformerModelElement() {
		super();
	}

	public XpathTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntXmlSchemaConstants.ELEM_XPATH_TRANSFORMER;
	}
