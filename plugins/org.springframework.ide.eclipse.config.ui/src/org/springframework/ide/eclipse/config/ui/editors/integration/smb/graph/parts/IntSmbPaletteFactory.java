...
public class IntSmbPaletteFactory implements IPaletteFactory {
	...
	public PaletteDrawer createPaletteDrawer(AbstractConfigGraphDiagram diagram, String namespaceUri) {
		...
		CombinedTemplateCreationEntry entry = new CombinedTemplateCreationEntry(
				IntSmbSchemaConstants.ELEM_INBOUND_CHANNEL_ADAPTER,
				Messages.IntSmbPaletteFactory_INBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
		...
		entry = new CombinedTemplateCreationEntry(IntSmbSchemaConstants.ELEM_OUTBOUND_CHANNEL_ADAPTER,
				Messages.IntSmbPaletteFactory_OUTBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
