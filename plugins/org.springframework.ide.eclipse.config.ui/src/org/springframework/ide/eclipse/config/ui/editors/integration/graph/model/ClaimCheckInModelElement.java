...
public class ClaimCheckInModelElement extends Activity {

	public ClaimCheckInModelElement() {
		super();
	}

	public ClaimCheckInModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_CLAIM_CHECK_IN;
	}
