 ...
 * {@link ToolAnnotationBasedHyperlinkCalculator} as its hyperlink calculator.
 * @author Leo Dos Santos
 * @author Christian Dupuis
 * @since 2.3.0
 */
@SuppressWarnings("restriction")
public class ToolAnnotationBasedHyperlinkProvider extends XmlBackedHyperlinkProvider {
	 ...
	 * for
	 */
	public ToolAnnotationBasedHyperlinkProvider(ITextViewer textViewer, IDOMElement input, String attrName) {
		super(textViewer, input, attrName);
	}

	@Override
	protected IHyperlinkCalculator createHyperlinkCalculator() {
		return new ToolAnnotationBasedHyperlinkCalculator();
	}
