...
public class Messages extends NLS {
	...
	public static String IntRedisPaletteFactory_OUTBOUND_GATEWAY_COMPONENT_DESCRIPTION;
	...
	public static String IntRedisPaletteFactory_QUEUE_INBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION;

	public static String IntRedisPaletteFactory_QUEUE_INBOUND_GATEWAY_COMPONENT_DESCRIPTION;

	public static String IntRedisPaletteFactory_QUEUE_OUTBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION;

	public static String IntRedisPaletteFactory_QUEUE_OUTBOUND_GATEWAY_COMPONENT_DESCRIPTION;
