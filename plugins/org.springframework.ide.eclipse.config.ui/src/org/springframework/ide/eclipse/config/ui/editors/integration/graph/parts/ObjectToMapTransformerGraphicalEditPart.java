 ...
 */
public class ObjectToMapTransformerGraphicalEditPart extends BorderedIntegrationPart {

	public ObjectToMapTransformerGraphicalEditPart(ObjectToMapTransformerModelElement transformer) {
		super(transformer);
	}
	...
	@Override
	public ObjectToMapTransformerModelElement getModelElement() {
		return (ObjectToMapTransformerModelElement) getModel();
	}
