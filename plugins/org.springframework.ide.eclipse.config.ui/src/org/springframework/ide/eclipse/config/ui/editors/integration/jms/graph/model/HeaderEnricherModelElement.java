...
public class HeaderEnricherModelElement extends Activity {
	...
	public String getInputName() {
		return IntJmsSchemaConstants.ELEM_HEADER_ENRICHER;
	}

	@Override
	public List<String> getPrimaryIncomingAttributes() {
		return Arrays.asList(IntJmsSchemaConstants.ATTR_INPUT_CHANNEL);
	}

	@Override
	public List<String> getPrimaryOutgoingAttributes() {
		return Arrays.asList(IntJmsSchemaConstants.ATTR_OUTPUT_CHANNEL);
	}
