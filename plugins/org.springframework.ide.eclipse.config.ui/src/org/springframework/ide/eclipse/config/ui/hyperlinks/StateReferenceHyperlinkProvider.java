 ...
 * {@link StateReferenceHyperlinkCalculator} as its hyperlink calculator.
 * @author Leo Dos Santos
 * @since 2.3.4
 */
@SuppressWarnings("restriction")
public class StateReferenceHyperlinkProvider extends XmlBackedHyperlinkProvider {
	 ...
	 * for
	 */
	public StateReferenceHyperlinkProvider(ITextViewer textViewer, IDOMElement input, String attrName) {
		super(textViewer, input, attrName);
	}

	@Override
	protected IHyperlinkCalculator createHyperlinkCalculator() {
		return new StateReferenceHyperlinkCalculator();
	}
