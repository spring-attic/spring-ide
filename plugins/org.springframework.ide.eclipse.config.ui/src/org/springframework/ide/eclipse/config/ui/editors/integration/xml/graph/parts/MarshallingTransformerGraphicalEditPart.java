 ...
 */
public class MarshallingTransformerGraphicalEditPart extends BorderedIntegrationPart {

	public MarshallingTransformerGraphicalEditPart(MarshallingTransformerModelElement transformer) {
		super(transformer);
	}
	...
	@Override
	public MarshallingTransformerModelElement getModelElement() {
		return (MarshallingTransformerModelElement) getModel();
	}
