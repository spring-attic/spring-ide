...
public class JeeMasterPart extends AbstractNamespaceMasterPart {

	public JeeMasterPart(AbstractConfigFormPage page, Composite parent) {
		super(page, parent);
	}
	...
	protected String getSectionTitle() {
		return Messages.getString("JeeMasterPart.MASTER_SECTION_TITLE"); //$NON-NLS-1$
	}
