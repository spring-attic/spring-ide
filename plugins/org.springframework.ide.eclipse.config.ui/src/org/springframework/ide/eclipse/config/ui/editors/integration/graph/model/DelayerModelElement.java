...
public class DelayerModelElement extends Activity {

	public DelayerModelElement() {
		super();
	}

	public DelayerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_DELAYER;
	}
