 ...
 */
public class ToggleSubflowStateAction extends SelectionAction implements IPropertyChangeListener {

	public static String ID_ACTION = SpringConfigPreferenceConstants.PREF_DISPLAY_SUBFLOW_STATE;

	private final IPreferenceStore prefStore;

	public ToggleSubflowStateAction(IWorkbenchPart part) {
		super(part);
		setId(ID_ACTION);
		setText(Messages.ToggleSubflowStateAction_ACTION_LABEL);
