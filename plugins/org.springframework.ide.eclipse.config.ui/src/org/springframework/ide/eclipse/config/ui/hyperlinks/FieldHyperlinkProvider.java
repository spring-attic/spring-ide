 ...
 * {@link FieldHyperlinkCalculator} as its hyperlink calculator.
 * @author Leo Dos Santos
 * @author Christian Dupuis
 * @since 2.0.0
 */
@SuppressWarnings("restriction")
public class FieldHyperlinkProvider extends XmlBackedHyperlinkProvider {
	 ...
	 * for
	 */
	public FieldHyperlinkProvider(ITextViewer textViewer, IDOMElement input, String attrName) {
