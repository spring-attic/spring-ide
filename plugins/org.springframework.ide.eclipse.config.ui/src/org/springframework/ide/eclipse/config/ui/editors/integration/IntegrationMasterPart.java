...
public class IntegrationMasterPart extends AbstractNamespaceMasterPart {

	public IntegrationMasterPart(AbstractConfigFormPage page, Composite parent) {
		super(page, parent);
	}
	...
	protected String getSectionTitle() {
		return Messages.getString("IntegrationMasterPart.MASTER_SECTION_TITLE"); //$NON-NLS-1$
	}
