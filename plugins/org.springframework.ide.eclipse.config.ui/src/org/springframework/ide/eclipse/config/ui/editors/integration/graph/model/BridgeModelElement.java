...
public class BridgeModelElement extends Activity {

	public BridgeModelElement() {
		super();
	}

	public BridgeModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_BRIDGE;
	}
