...
public class ObjectToJsonTransformerModelElement extends Activity {

	public ObjectToJsonTransformerModelElement() {
		super();
	}

	public ObjectToJsonTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_OBJECT_TO_JSON_TRANSFORMER;
	}
