 ...
 */
public class SyslogToMapTransformerGraphicalEditPart extends BorderedIntegrationPart {

	public SyslogToMapTransformerGraphicalEditPart(SyslogToMapTransformerModelElement transformer) {
		super(transformer);
	}
	...
	@Override
	public SyslogToMapTransformerModelElement getModelElement() {
		return (SyslogToMapTransformerModelElement) getModel();
	}
