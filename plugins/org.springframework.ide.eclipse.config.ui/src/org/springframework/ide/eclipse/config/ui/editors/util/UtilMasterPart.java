...
public class UtilMasterPart extends AbstractNamespaceMasterPart {

	public UtilMasterPart(AbstractConfigFormPage page, Composite parent) {
		super(page, parent);
	}
	...
	protected String getSectionTitle() {
		return Messages.getString("UtilMasterPart.MASTER_SECTION_TITLE"); //$NON-NLS-1$
	}
