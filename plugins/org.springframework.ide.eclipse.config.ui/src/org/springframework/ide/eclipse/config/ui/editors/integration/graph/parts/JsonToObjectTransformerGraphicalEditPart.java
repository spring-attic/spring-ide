 ...
 */
public class JsonToObjectTransformerGraphicalEditPart extends BorderedIntegrationPart {

	public JsonToObjectTransformerGraphicalEditPart(JsonToObjectTransformerModelElement transformer) {
		super(transformer);
	}
	...
	@Override
	public JsonToObjectTransformerModelElement getModelElement() {
		return (JsonToObjectTransformerModelElement) getModel();
	}
