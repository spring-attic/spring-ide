...
public class HeaderValueRouterModelElement extends AbstractRouterModelElement {

	public HeaderValueRouterModelElement() {
		super();
	}

	public HeaderValueRouterModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_HEADER_VALUE_ROUTER;
	}
