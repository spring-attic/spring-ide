...
public class SyslogToMapTransformerModelElement extends Activity {

	public SyslogToMapTransformerModelElement() {
		super();
	}

	public SyslogToMapTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_SYSLOG_TO_MAP_TRANSFORMER;
	}
