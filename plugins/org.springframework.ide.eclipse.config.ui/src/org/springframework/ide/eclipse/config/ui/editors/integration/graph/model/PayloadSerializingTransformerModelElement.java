...
public class PayloadSerializingTransformerModelElement extends Activity {

	public PayloadSerializingTransformerModelElement() {
		super();
	}

	public PayloadSerializingTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_PAYLOAD_SERIALIZING_TRANSFORMER;
	}
