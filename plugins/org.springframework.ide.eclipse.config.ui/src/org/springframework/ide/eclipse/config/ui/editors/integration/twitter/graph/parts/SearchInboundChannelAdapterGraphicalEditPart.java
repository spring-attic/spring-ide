 ...
 */
public class SearchInboundChannelAdapterGraphicalEditPart extends BorderedIntegrationPart {

	public SearchInboundChannelAdapterGraphicalEditPart(SearchInboundChannelAdapterModelElement adapter) {
		super(adapter);
	}
	...
	@Override
	public SearchInboundChannelAdapterModelElement getModelElement() {
		return (SearchInboundChannelAdapterModelElement) getModel();
	}
