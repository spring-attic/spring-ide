 ...
 */
public class ToggleViewStateAction extends SelectionAction implements IPropertyChangeListener {

	public static String ID_ACTION = SpringConfigPreferenceConstants.PREF_DISPLAY_VIEW_STATE;

	private final IPreferenceStore prefStore;

	public ToggleViewStateAction(IWorkbenchPart part) {
		super(part);
		setId(ID_ACTION);
		setText(Messages.ToggleViewStateAction_ACTION_LABEL);
