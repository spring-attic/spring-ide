...
public class QueueOutboundGatewayModelElement extends AbstractOutboundGatewayModelElement {

	public QueueOutboundGatewayModelElement() {
		super();
	}

	public QueueOutboundGatewayModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntRedisSchemaConstants.ELEM_QUEUE_OUTBOUND_GATEWAY;
	}
