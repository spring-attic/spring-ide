...
public class ChainModelElement extends SimpleActivityWithContainer {

	public ChainModelElement() {
		super();
	}

	public ChainModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}
