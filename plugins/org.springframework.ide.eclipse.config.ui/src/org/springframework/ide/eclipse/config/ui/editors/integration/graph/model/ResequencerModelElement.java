...
public class ResequencerModelElement extends Activity {

	public ResequencerModelElement() {
		super();
	}

	public ResequencerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_RESEQUENCER;
	}
