...
public class SplitModelElement extends SimpleActivityWithContainer {

	public SplitModelElement() {
		super();
	}

	public SplitModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return BatchSchemaConstants.ELEM_SPLIT;
	}
