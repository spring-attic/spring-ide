...
public class PayloadTypeRouterModelElement extends AbstractRouterModelElement {

	public PayloadTypeRouterModelElement() {
		super();
	}

	public PayloadTypeRouterModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_PAYLOAD_TYPE_ROUTER;
	}
