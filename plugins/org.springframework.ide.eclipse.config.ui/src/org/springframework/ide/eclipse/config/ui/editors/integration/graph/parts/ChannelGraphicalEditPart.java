 ...
 */
public class ChannelGraphicalEditPart extends BadgedIntegrationPart {

	public ChannelGraphicalEditPart(AbstractChannelModelElement channel, ImageDescriptor mainImageDescriptor,
			ImageDescriptor auxImageDescriptor) {
		super(channel, mainImageDescriptor, auxImageDescriptor);
	}
