 ...
 */
public class StoredProcOutboundGatewayGraphicalEditPart extends BorderedIntegrationPart {

	public StoredProcOutboundGatewayGraphicalEditPart(StoredProcOutboundGatewayModelElement gateway) {
		super(gateway);
	}
	...
	@Override
	public StoredProcOutboundGatewayModelElement getModelElement() {
		return (StoredProcOutboundGatewayModelElement) getModel();
	}
