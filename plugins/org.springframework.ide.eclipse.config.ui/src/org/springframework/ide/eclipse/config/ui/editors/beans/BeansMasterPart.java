...
public class BeansMasterPart extends AbstractNamespaceMasterPart {

	public BeansMasterPart(AbstractConfigFormPage page, Composite parent) {
		super(page, parent);
	}
	...
	protected String getSectionTitle() {
		return Messages.getString("BeansMasterPart.MASTER_SECTION_TITLE"); //$NON-NLS-1$
	}
