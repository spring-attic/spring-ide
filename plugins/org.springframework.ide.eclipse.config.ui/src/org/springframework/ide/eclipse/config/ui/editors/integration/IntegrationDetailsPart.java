...
public class IntegrationDetailsPart extends AbstractNamespaceDetailsPart {

	public IntegrationDetailsPart(AbstractConfigMasterPart master) {
		super(master);
	}

	public IntegrationDetailsPart(AbstractConfigMasterPart master, String docsUrl) {
	...
	public SpringConfigDetailsSectionPart createDetailsSectionPart(AbstractConfigEditor editor, IDOMElement input,
		...
		return new IntegrationDetailsSectionPart(editor, input, parent, toolkit);
	}
