 ...
 *******************************************************************************/
package org.springframework.ide.eclipse.config.ui.editors.tx;
...
public class TxDetailsPart extends AbstractNamespaceDetailsPart {

	public TxDetailsPart(AbstractConfigMasterPart master) {
		super(master);
	}

	public TxDetailsPart(AbstractConfigMasterPart master, String docsUrl) {
	...
	public SpringConfigDetailsSectionPart createDetailsSectionPart(AbstractConfigEditor editor, IDOMElement input,
		...
		return new TxDetailsSectionPart(editor, input, parent, toolkit);
	}
