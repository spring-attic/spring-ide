 ...
 */
public class StopConnectionCreateCommand extends AbstractConnectionCreateCommand {

	protected String oldTargetId;

	protected String targetId;

	public StopConnectionCreateCommand(ITextEditor textEditor, int lineStyle) {
	...
	public boolean canExecute() {
		if (super.canExecute()) {
			oldTargetId = sourceElement.getAttribute(BatchSchemaConstants.ATTR_RESTART);
	...
	@Override
	public void execute() {
		sourceElement.setAttribute(BatchSchemaConstants.ATTR_RESTART, targetId);
	}
