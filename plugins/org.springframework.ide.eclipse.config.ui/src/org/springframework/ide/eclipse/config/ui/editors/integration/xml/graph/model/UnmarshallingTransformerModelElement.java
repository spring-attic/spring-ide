...
public class UnmarshallingTransformerModelElement extends Activity {

	public UnmarshallingTransformerModelElement() {
		super();
	}

	public UnmarshallingTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntXmlSchemaConstants.ELEM_UNMARSHALLING_TRANSFORMER;
	}
