 ...
 */
public class TransformerGraphicalEditPart extends BorderedIntegrationPart {

	public TransformerGraphicalEditPart(TransformerModelElement transformer) {
		super(transformer);
	}
	...
	@Override
	public TransformerModelElement getModelElement() {
		return (TransformerModelElement) getModel();
	}
