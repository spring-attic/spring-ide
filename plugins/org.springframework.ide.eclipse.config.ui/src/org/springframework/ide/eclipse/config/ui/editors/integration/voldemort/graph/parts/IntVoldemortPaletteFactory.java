...
public class IntVoldemortPaletteFactory implements IPaletteFactory {

	public PaletteDrawer createPaletteDrawer(AbstractConfigGraphDiagram diagram, String namespaceUri) {
		PaletteDrawer drawer = new PaletteDrawer("", IntegrationImages.BADGE_SI_VOLDEMORT); //$NON-NLS-1$
		List<PaletteEntry> entries = new ArrayList<PaletteEntry>();

		CombinedTemplateCreationEntry entry = new CombinedTemplateCreationEntry(
				IntVoldemortSchemaConstants.ELEM_INBOUND_CHANNEL_ADAPTER,
				Messages.IntVoldemortPaletteFactory_INBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
		...
		entry = new CombinedTemplateCreationEntry(IntVoldemortSchemaConstants.ELEM_OUTBOUND_CHANNEL_ADAPTER,
				Messages.IntVoldemortPaletteFactory_OUTBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
