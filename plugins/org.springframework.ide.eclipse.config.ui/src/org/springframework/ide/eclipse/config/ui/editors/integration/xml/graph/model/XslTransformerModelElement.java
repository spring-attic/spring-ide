...
public class XslTransformerModelElement extends Activity {

	public XslTransformerModelElement() {
		super();
	}

	public XslTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntXmlSchemaConstants.ELEM_XSLT_TRANSFORMER;
	}
