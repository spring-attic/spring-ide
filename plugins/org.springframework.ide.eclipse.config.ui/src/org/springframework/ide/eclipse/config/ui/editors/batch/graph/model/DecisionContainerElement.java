...
public class DecisionContainerElement extends ParallelActivity {

	public DecisionContainerElement() {
		super();
	}

	public DecisionContainerElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}
