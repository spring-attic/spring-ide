 ...
 * {@link PointcutReferenceHyperlinkCalculator} as its hyperlink calculator.
 * @author Leo Dos Santos
 * @author Christian Dupuis
 * @since 2.0.0
 */
@SuppressWarnings("restriction")
public class PointcutReferenceHyperlinkProvider extends XmlBackedHyperlinkProvider {
	 ...
	 * for
	 */
	public PointcutReferenceHyperlinkProvider(ITextViewer textViewer, IDOMElement input, String attrName) {
		super(textViewer, input, attrName);
	}

	@Override
	protected IHyperlinkCalculator createHyperlinkCalculator() {
		return new PointcutReferenceHyperlinkCalculator();
	}
