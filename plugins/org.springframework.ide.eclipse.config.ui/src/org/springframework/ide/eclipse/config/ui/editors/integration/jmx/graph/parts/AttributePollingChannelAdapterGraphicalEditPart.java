 ...
 */
public class AttributePollingChannelAdapterGraphicalEditPart extends BorderedIntegrationPart {

	public AttributePollingChannelAdapterGraphicalEditPart(AttributePollingChannelAdapterModelElement adapter) {
		super(adapter);
	}
	...
	@Override
	public AttributePollingChannelAdapterModelElement getModelElement() {
		return (AttributePollingChannelAdapterModelElement) getModel();
	}
