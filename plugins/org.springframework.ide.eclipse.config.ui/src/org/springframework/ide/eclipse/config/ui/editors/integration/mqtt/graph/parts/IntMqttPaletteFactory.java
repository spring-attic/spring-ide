...
public class IntMqttPaletteFactory implements IPaletteFactory {

	public PaletteDrawer createPaletteDrawer(AbstractConfigGraphDiagram diagram, String namespaceUri) {
		PaletteDrawer drawer = new PaletteDrawer("", IntegrationImages.BADGE_SI_MQTT); //$NON-NLS-1$
		List<PaletteEntry> entries = new ArrayList<PaletteEntry>();

		CombinedTemplateCreationEntry entry = new CombinedTemplateCreationEntry(
				IntMqttSchemaConstants.ELEM_INBOUND_CHANNEL_ADAPTER,
				Messages.IntMqttPaletteFactory_INBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
		...
		entry = new CombinedTemplateCreationEntry(IntMqttSchemaConstants.ELEM_OUTBOUND_CHANNEL_ADAPTER,
				Messages.IntMqttPaletteFactory_OUTBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
