...
public class TransformerModelElement extends Activity {

	public TransformerModelElement() {
		super();
	}

	public TransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_TRANSFORMER;
	}
