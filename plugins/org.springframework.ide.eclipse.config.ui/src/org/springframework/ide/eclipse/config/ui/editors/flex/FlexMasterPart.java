...
public class FlexMasterPart extends AbstractNamespaceMasterPart {

	public FlexMasterPart(AbstractConfigFormPage page, Composite parent) {
		super(page, parent);
	}
	...
	protected String getSectionTitle() {
		return Messages.getString("FlexMasterPart.MASTER_SECTION_TITLE"); //$NON-NLS-1$
	}
