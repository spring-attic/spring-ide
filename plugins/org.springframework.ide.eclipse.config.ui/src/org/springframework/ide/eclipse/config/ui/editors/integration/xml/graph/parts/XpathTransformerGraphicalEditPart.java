 ...
 */
public class XpathTransformerGraphicalEditPart extends BorderedIntegrationPart {

	public XpathTransformerGraphicalEditPart(XpathTransformerModelElement transformer) {
		super(transformer);
	}
	...
	@Override
	public XpathTransformerModelElement getModelElement() {
		return (XpathTransformerModelElement) getModel();
	}
