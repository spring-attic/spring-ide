...
public class PayloadDeserializingTransformerModelElement extends Activity {

	public PayloadDeserializingTransformerModelElement() {
		super();
	}

	public PayloadDeserializingTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_PAYLOAD_DESERIALIZING_TRANSFORMER;
	}
