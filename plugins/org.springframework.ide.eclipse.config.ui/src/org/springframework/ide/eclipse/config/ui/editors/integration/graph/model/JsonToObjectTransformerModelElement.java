...
public class JsonToObjectTransformerModelElement extends Activity {

	public JsonToObjectTransformerModelElement() {
		super();
	}

	public JsonToObjectTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_JSON_TO_OBJECT_TRANSFORMER;
	}
