...
public class MapToObjectTransformerModelElement extends Activity {

	public MapToObjectTransformerModelElement() {
		super();
	}

	public MapToObjectTransformerModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_MAP_TO_OBJECT_TRANSFORMER;
	}
