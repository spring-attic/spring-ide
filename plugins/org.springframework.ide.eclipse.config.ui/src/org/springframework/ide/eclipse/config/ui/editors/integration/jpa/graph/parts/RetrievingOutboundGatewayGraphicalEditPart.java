 ...
 */
public class RetrievingOutboundGatewayGraphicalEditPart extends BorderedIntegrationPart {

	public RetrievingOutboundGatewayGraphicalEditPart(RetrievingOutboundGatewayModelElement gateway) {
		super(gateway);
	}
	...
	@Override
	public RetrievingOutboundGatewayModelElement getModelElement() {
		return (RetrievingOutboundGatewayModelElement) getModel();
	}
