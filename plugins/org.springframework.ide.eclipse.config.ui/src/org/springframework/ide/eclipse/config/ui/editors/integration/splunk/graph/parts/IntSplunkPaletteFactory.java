...
import org.springframework.ide.eclipse.config.core.schemas.IntSplunkSchemaConstants;
...
public class IntSplunkPaletteFactory implements IPaletteFactory {

	public PaletteDrawer createPaletteDrawer(AbstractConfigGraphDiagram diagram, String namespaceUri) {
		PaletteDrawer drawer = new PaletteDrawer("", IntegrationImages.BADGE_SI_SPLUNK); //$NON-NLS-1$
		List<PaletteEntry> entries = new ArrayList<PaletteEntry>();

		CombinedTemplateCreationEntry entry = new CombinedTemplateCreationEntry(
				IntSplunkSchemaConstants.ELEM_INBOUND_CHANNEL_ADAPTER,
				Messages.IntSplunkPaletteFactory_INBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
		...
		entry = new CombinedTemplateCreationEntry(IntSplunkSchemaConstants.ELEM_OUTBOUND_CHANNEL_ADAPTER,
				Messages.IntSplunkPaletteFactory_OUTBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
