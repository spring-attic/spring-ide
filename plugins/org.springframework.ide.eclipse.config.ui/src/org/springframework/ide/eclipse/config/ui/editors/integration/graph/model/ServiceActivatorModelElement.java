...
public class ServiceActivatorModelElement extends Activity {

	public ServiceActivatorModelElement() {
		super();
	}

	public ServiceActivatorModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_SERVICE_ACTIVATOR;
	}
	...
	public List<String> getSecondaryOutgoingAttributes() {
		return Arrays.asList(IntegrationSchemaConstants.ATTR_REF);
	}
