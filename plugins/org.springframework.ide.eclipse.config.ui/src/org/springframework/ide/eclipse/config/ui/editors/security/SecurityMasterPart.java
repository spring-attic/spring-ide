...
public class SecurityMasterPart extends AbstractNamespaceMasterPart {

	public SecurityMasterPart(AbstractConfigFormPage page, Composite parent) {
		super(page, parent);
	}
	...
	protected String getSectionTitle() {
		return Messages.getString("SecurityMasterPart.MASTER_SECTION_TITLE"); //$NON-NLS-1$
	}
