...
public class ResourceInboundChannelAdapterModelElement extends AbstractInboundChannelAdapterModelElement {
	...
	public ResourceInboundChannelAdapterModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntegrationSchemaConstants.ELEM_RESOURCE_INBOUND_CHANNEL_ADAPTER;
	}
