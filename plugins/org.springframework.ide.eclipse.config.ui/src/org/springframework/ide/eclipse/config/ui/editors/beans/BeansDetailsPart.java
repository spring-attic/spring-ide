...
public class BeansDetailsPart extends AbstractNamespaceDetailsPart {

	public BeansDetailsPart(AbstractConfigMasterPart master) {
		super(master);
	}

	public BeansDetailsPart(AbstractConfigMasterPart master, String docsUrl) {
	...
	public SpringConfigDetailsSectionPart createDetailsSectionPart(AbstractConfigEditor editor, IDOMElement input,
		...
		return new BeansDetailsSectionPart(editor, input, parent, toolkit);
	}
