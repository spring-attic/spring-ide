...
public class XpathFilterModelElement extends Activity {

	public XpathFilterModelElement() {
		super();
	}

	public XpathFilterModelElement(IDOMElement input, AbstractConfigGraphDiagram diagram) {
		super(input, diagram);
	}

	@Override
	public String getInputName() {
		return IntXmlSchemaConstants.ELEM_XPATH_FILTER;
	}
