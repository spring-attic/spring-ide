...
public class IntSmppPaletteFactory implements IPaletteFactory {
	...
	public PaletteDrawer createPaletteDrawer(AbstractConfigGraphDiagram diagram, String namespaceUri) {
		...
		CombinedTemplateCreationEntry entry = new CombinedTemplateCreationEntry(
				IntSmppSchemaConstants.ELEM_INBOUND_CHANNEL_ADAPTER,
				Messages.IntSmppPaletteFactory_INBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
		...
		entry = new CombinedTemplateCreationEntry(IntSmppSchemaConstants.ELEM_OUTBOUND_CHANNEL_ADAPTER,
				Messages.IntSmppPaletteFactory_OUTBOUND_CHANNEL_ADAPTER_COMPONENT_DESCRIPTION,
		...
		entry = new CombinedTemplateCreationEntry(IntSmppSchemaConstants.ELEM_INBOUND_GATEWAY,
				Messages.IntSmppPaletteFactory_INBOUND_GATEWAY_COMPONENT_DESCRIPTION, new ModelElementCreationFactory(
		...
		entry = new CombinedTemplateCreationEntry(IntSmppSchemaConstants.ELEM_OUTBOUND_GATEWAY,
				Messages.IntSmppPaletteFactory_OUTBOUND_GATEWAY_COMPONENT_DESCRIPTION, new ModelElementCreationFactory(
