...
public class OpenInPackageExplorer extends AbstractBootDashElementsAction {
	...
	public OpenInPackageExplorer(MultiSelection<BootDashElement> selection, UserInteractions ui) {
		...
		this.setImageDescriptor(BootDashActivator.getImageDescriptor("icons/package.gif"));
		this.setDisabledImageDescriptor(BootDashActivator.getImageDescriptor("icons/package.gif"));
	}
