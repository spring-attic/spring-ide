 ...
 *******************************************************************************/
package org.springframework.ide.eclipse.boot.util.livexp.ui;
 ...
 * {@link PageSection}s.
 * <p>
 * Deprecated: This is a drop-in replacement for {@link DialogWithSections}. It is meant to replace that class.
 * So once e-i-commons master is open for changes again we should:
 *   - replace the DialogWithSections class in e-i-commons with this class
 *   - delete this class
 *   - replace references to this class with references to {@link DialogWithSections}
 *
 * @author Kris De Volder
 */
@Deprecated
public abstract class ReflowableDialogWithSections
	...
	implements ValueListener<ValidationResult>, IPageWithSections, IPageWithOkButton, Reflowable
{
	...
	public ReflowableDialogWithSections(String title, OkButtonHandler model, Shell shell) {
		super(shell);
		this.title = title;
		this.model = model;
	}
