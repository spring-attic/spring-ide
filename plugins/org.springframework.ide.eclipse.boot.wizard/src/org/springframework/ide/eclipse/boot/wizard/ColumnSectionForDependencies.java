 ...
 * wizard: column 3 is the selection section.
 * 
 *
 *
 */
@Deprecated
public class ColumnSectionForDependencies extends FilteredDependenciesSection {

	public ColumnSectionForDependencies(IPageWithSections owner, NewSpringBootWizardModel model) {
