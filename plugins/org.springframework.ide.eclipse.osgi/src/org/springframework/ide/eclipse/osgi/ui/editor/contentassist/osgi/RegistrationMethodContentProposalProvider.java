 ...
 * {@link RegistrationMethodContentAssistCalculator} as its content assist
 * calculator.
...
public class RegistrationMethodContentProposalProvider extends XmlBackedContentProposalProvider {
	 ...
	 */
	public RegistrationMethodContentProposalProvider(IDOMElement input, String attrName) {
		super(input, attrName);
	}

	@Override
	protected IContentAssistCalculator createContentAssistCalculator() {
		return new RegistrationMethodContentAssistCalculator();
	}
