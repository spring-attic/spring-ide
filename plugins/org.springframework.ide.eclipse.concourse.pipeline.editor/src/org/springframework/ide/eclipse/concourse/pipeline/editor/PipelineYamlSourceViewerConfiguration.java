 ...
 */
public class PipelineYamlSourceViewerConfiguration extends AbstractYamlSourceViewerConfiguration {

	private PipelineYmlSchema schema = new PipelineYmlSchema(ConcourseEditorActivator.getDefault().getBuildpackProvider());
	private YamlAssistContextProvider assistContextProvider = new SchemaBasedYamlAssistContextProvider(schema);

	public PipelineYamlSourceViewerConfiguration(Provider<Shell> shellProvider) {
		super(shellProvider);
	}
	...
	protected IDialogSettings getPluginDialogSettings() {
		return ConcourseEditorActivator.getDefault().getDialogSettings();
	}
	...
	protected IPreferenceStore getPreferencesStore() {
		return ConcourseEditorActivator.getDefault().getPreferenceStore();
	}

	@Override
	protected String getPluginId() {
		return ConcourseEditorActivator.PLUGIN_ID;
	}
}
