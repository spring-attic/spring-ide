...
public class ConcourseEditorActivator extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.springframework.ide.eclipse.concourse.pipeline.editor"; //$NON-NLS-1$

	// The shared instance
	private static ConcourseEditorActivator plugin;

	/**
	 * The constructor
	 */
	public ConcourseEditorActivator() {
	}
	 ...
	 */
	public static ConcourseEditorActivator getDefault() {
		return plugin;
	}
