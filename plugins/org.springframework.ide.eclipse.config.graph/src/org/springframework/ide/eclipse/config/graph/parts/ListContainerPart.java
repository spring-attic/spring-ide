...
import org.springframework.ide.eclipse.config.graph.figures.ListContainerFigure;
 ...
 */
public abstract class ListContainerPart extends StructuredActivityPart {

	public ListContainerPart(StructuredActivity activity) {
		super(activity);
	}
	...
	protected IFigure createFigure() {
		...
		return new ListContainerFigure(direction);
	}
