...
public class InputMapperComposite {
	...
	private class InputMapperContentProvider implements IStructuredContentProvider {
	...
	public InputMapperComposite(IDialogValidator validator, TabItem item, Shell parentShell,
