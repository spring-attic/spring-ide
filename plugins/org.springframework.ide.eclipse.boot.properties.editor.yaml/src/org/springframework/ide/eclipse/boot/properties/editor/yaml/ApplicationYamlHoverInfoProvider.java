...
public class ApplicationYamlHoverInfoProvider extends YamlHoverInfoProvider {
	...
	public ApplicationYamlHoverInfoProvider(YamlASTProvider astProvider, YamlStructureProvider structureProvider, YamlAssistContextProvider assistContextProvider) {
		super(astProvider);
