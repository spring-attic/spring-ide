...
public class SpringYamlReconcileEngine implements IReconcileEngine {
	...
	public SpringYamlReconcileEngine(YamlASTProvider astProvider, SpringPropertyIndexProvider indexProvider) {
	...
	public void reconcile(IDocument doc, IProblemCollector problemCollector, IProgressMonitor mon) {
		...
		try {
			...
			if (index!=null && !index.isEmpty()) {
				...
				YamlASTReconciler reconciler = new YamlASTReconciler(problemCollector);
