 ...
 *
 * <p>
 * <b>NOTE:</b> For XML bean definition files, an {@code &lt;alias&gt;} tag is
 * available that effectively achieves the same.
 *
 * <p>
 * A special capability of this FactoryBean is enabled through its configuration
 * as bean definition: The "targetBeanName" can be substituted through a
 * placeholder, in combination with Spring's
 * {@link PropertyPlaceholderConfigurer}. Thanks to Marcus Bristav for pointing
 * this out!
 *
...
public class BeanReferenceFactoryBean implements SmartFactoryBean, BeanFactoryAware {
	 ...
	 * <p>
	 * This property is required. The value for this property can be substituted
	 * through a placeholder, in combination with Spring's
