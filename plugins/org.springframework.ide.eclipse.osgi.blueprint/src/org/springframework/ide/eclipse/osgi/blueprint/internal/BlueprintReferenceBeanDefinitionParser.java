 ...
 * 
 */
public class BlueprintReferenceBeanDefinitionParser extends AbstractBeanDefinitionParser {
	...
	private void parseAttributes(Element element, BeanDefinitionBuilder builder, AttributeCallback[] callbacks,
		...
		ParserUtils.parseCustomAttributes(element, builder,
				ParserUtils.mergeCallbacks(callbacks, new AttributeCallback[] { timeoutCallback, blueprintCallback }));
