...
public class BeanMethodContentProposalProvider extends XmlBackedContentProposalProvider {
	 ...
	 */
	public BeanMethodContentProposalProvider(IDOMElement input, String attrName) {
		super(input, attrName);
	}

	@Override
	protected IContentAssistCalculator createContentAssistCalculator() {
		return new BeanMethodContentAssistCalculator();
	}
