...
/**
 * A data structure that associates property names to values of a given type.
 * <p>
 * The map is organized as a tree internally so that is efficient to retrieve a
 * 'sub' tree of this map based on 
 * 
