 ...
 *******************************************************************************/
package org.springframework.ide.eclipse.batch;
...
public class BatchUIImages {
	 ...
	 */
	public static final String IMG_OBJS_BATCH = NAME_PREFIX
			+ "spring_batch_obj.gif";

	public static final ImageDescriptor DESC_OBJS_BATCH = createManaged(
			STRUCTURE, IMG_OBJS_BATCH);
