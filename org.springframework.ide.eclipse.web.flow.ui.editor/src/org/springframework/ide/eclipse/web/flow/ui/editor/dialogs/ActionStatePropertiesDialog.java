...
public class ActionStatePropertiesDialog extends TitleAreaDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        configsViewer2.setContentProvider(new PropertiesContentProvider(
                this.actionStateClone, configsViewer2));
        ...
        configsViewer2.setInput(this.actionStateClone);
        ...
        addButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                new Property(actionStateClone, "name", "value");
            }
        });
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (selection.getFirstElement() != null) {
                    if (selection.getFirstElement() instanceof IProperty) {
                        actionStateClone.removeProperty((IProperty) selection
                                .getFirstElement());
                    }
                }
            }
