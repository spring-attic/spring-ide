...
class InputOutputContentProvider implements IStructuredContentProvider,
    ...
    private IAttributeMapper project;

    private TableViewer viewer;

    private boolean useInputs = true;

    public InputOutputContentProvider(IAttributeMapper project,
            TableViewer viewer) {
    ...
    public InputOutputContentProvider(IAttributeMapper project,
            TableViewer viewer, boolean useInputs) {
        this.project = project;
        this.viewer = viewer;
    ...
    public Object[] getElements(Object obj) {
        if (project instanceof IAttributeMapper && useInputs) {
            return ((IAttributeMapper) project).getInputs().toArray();
        } else if (project instanceof IAttributeMapper && !useInputs) {
            return ((IAttributeMapper) project).getOutputs().toArray();
        } else
            return null;
    }
