...
public class AdviceAopTargetMethod implements IReferenceNode, IRevealableReferenceNode {
    ...
    public AdviceAopTargetMethod(IAopReference reference) {
    ...
    public Image getImage() {
        return labelProvider.getImage(reference.getTarget());
    }
