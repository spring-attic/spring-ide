 ...
 */
package org.springframework.ide.eclipse.aop.core.parser.asm;
...
public class AdviceAnnotationVisitor
        ...
        if (lastAspectDefinition != null) {
            if (lastAspectDefinition instanceof AnnotationAspectDefinition) {
                if ("value".equals(name) || "pointcut".equals(name)) {
                    ((AnnotationAspectDefinition) lastAspectDefinition).setPointcutExpression(value
                            .toString());
                }
                ...
                if ("defaultImpl".equals(name)) {
                    ...
                    ((AnnotationIntroductionDefinition) lastAspectDefinition).setTypePattern(value
                            .toString());
                }
            }
        }
