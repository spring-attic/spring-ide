 ...
 * <code>"http://www.springframework.org/schema/jms"</code>.
 * @author Christian Dupuis
 * @since 2.0.2
 */
public class JmsNamespaceLabelProvider extends DefaultNamespaceLabelProvider {
	...
	private Image getNamespaceImage(ISourceModelElement element,
		...
		if (isDecorating) {
			return BeansModelImages.getDecoratedImage(BeansUIImages
					.getImage(BeansUIImages.IMG_OBJS_JMS), element,	context);
		}
		else {
			return BeansUIImages.getImage(BeansUIImages.IMG_OBJS_JMS);
		}
	}
}
