...
public class WebFlowProjectDescriptionHandler extends DefaultHandler implements
    ...
    protected static final int S_CONFIG_SET_BEAN_CONFIG_SET = 7;
    ...
    protected WebFlowConfigSet configSet;
    ...
    public WebFlowProjectDescriptionHandler(IWebFlowProject project) {
        ...
        problems = new MultiStatus(WebFlowCorePlugin.PLUGIN_ID,
    ...
    public void startElement(String uri, String elementName, String qname,
        ...
        switch (state) {
            case S_INITIAL:
                if (elementName.equals(PROJECT_DESCRIPTION)) {
                    ...
                    throw new SAXParseException(
                            "No Spring project description", locator);
                }
                break;
            ...
            case S_CONFIG_SET:
                ...
                else if (elementName.equals(BEANS_CONFIG_NAME)) {
                    state = S_CONFIG_SET_BEAN_CONFIG_SET;
                }
                break;
        ...
        switch (state) {
            ...
            case S_CONFIG_SET_NAME:
                if (elementName.equals(NAME)) {
                    ...
                    configSet = new WebFlowConfigSet(project, name);
                    state = S_CONFIG_SET;
                }
                break;

            case S_CONFIG_SET_BEAN_CONFIG_SET:
                if (elementName.equals(BEANS_CONFIG_NAME)) {
                    String name = charBuffer.toString().trim();
                    configSet.setBeansConfigSetElementName(name);
                    state = S_CONFIG_SET;
                }
                break;
    ...
    public void log(int code, String errorMessage, Throwable error) {
        problems.add(new Status(code, WebFlowCorePlugin.PLUGIN_ID,
