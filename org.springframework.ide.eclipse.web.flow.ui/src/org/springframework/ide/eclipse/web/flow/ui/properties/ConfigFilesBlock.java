...
public class ConfigFilesBlock {
    ...
    public Control createControl(Composite parent) {
        ...
        description.setText(WebFlowUIPlugin.getResourceString(DESCRIPTION));
    ...
    private void handleAddButtonPressed() {
        ...
        dialog.setTitle(WebFlowUIPlugin.getResourceString(DIALOG_TITLE));
        dialog.setMessage(WebFlowUIPlugin.getResourceString(DIALOG_MESSAGE));
