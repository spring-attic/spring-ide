...
public class ProjectNode extends AbstractNode {
    ...
    public ProjectNode(INode parent, String name) {
        super(parent, name);
        this.project = WebFlowCorePlugin.getModel().getProject(name);
        this.configs = new HashMap();
        this.configSets = new HashMap();
        this.listeners = new ListenerList();
    }

    public IWebFlowProject getWebFlowProject() {
        return project;
    }
    ...
    public void setConfigSets(Collection configSets) {
        ...
        while (iter.hasNext()) {
            addConfigSet((IWebFlowConfigSet) iter.next());
        }
    ...
    public ConfigSetNode getConfigSet(String name) {
        return (configSets.containsKey(name) ? (ConfigSetNode) configSets
                .get(name) : null);
    }
