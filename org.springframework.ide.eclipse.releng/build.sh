...
ECLIPSE_TEAMP_NAME=eclipse-base.tar.gz
...
install_feature () {
	...
	output=`java -cp $ECLIPSELOCATION org.eclipse.equinox.launcher.Main -application org.eclipse.update.core.standaloneUpdate -command search -from $2` 
