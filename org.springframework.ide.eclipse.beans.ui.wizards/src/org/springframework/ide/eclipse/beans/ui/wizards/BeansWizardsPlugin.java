 ...
 */
public class BeansWizardsPlugin extends AbstractUIPlugin {

	/**
	 * Plugin identifier for Spring Beans UI (value
	 * <code>org.springframework.ide.eclipse.beans.ui</code>).
	 */
	public static final String PLUGIN_ID ="org.springframework.ide.eclipse.beans.ui.wizards";
	private static final String RESOURCE_NAME = PLUGIN_ID + ".messages";

	/** The shared instance. */
	private static BeansWizardsPlugin plugin;
	 ...
	 */
	public static BeansWizardsPlugin getDefault() {
		return plugin;
	}
